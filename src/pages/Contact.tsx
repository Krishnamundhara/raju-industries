    ...
    <div className="bg-white">
      ...
      <div className="relative bg-gray-900 text-white overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto py-24 px-4 sm:py-32 sm:px-6 lg:px-8 text-center">
          ...
          <div className="w-24 h-1 bg-gradient-to-r from-blue-500 via-red-500 to-yellow-500 mx-auto mb-6"></div>
      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 -mt-0">
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8 transform transition duration-300 hover:shadow-md">
            <div className="bg-blue-100 rounded-full p-3 w-16 h-16 mx-auto mb-5 flex items-center justify-center">
            ...
            <p className="text-gray-600 text-sm text-center">
              <span className="font-medium">Raju Industries</span>
              <br />
              <span className="text-blue-600">Govind Mundhara</span>{" "}
              (Proprietor)
              <br />
          ...
          {/* Email Information - Yellow/Golden */}
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8 transform transition duration-300 hover:shadow-md">
            <div className="bg-yellow-100 rounded-full p-3 w-16 h-16 mx-auto mb-5 flex items-center justify-center">
            ...
            <div className="flex justify-center">
              <a
                ...
                className="flex items-center px-6 py-2 bg-yellow-50 hover:bg-yellow-100 rounded-full transition-colors duration-300 hover:text-yellow-600 text-sm"
              >
        ...
        <div className="mt-16 relative">
          <div className="relative bg-white rounded-lg border border-gray-200 p-8 lg:p-12">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-gray-900 inline-block relative">
                <span className="relative inline-block">
                  Connect With Us
                  <span className="absolute bottom-0 left-0 w-full h-1 bg-gradient-to-r from-blue-500 via-red-500 to-yellow-500"></span>
                </span>
              </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
              ...
              <div className="bg-gray-50 rounded-lg p-6 lg:p-8 border border-gray-200">
                ...
                <form onSubmit={handleWhatsAppSubmit} className="space-y-5">
                  <div>
                    ...
                    <div className="relative rounded-lg">
                      ...
                      <input
                        ...
                        } rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent text-gray-900`}
                  ...
                  <button
                    type="submit"
                    className="w-full flex justify-center items-center px-6 py-3 border border-transparent rounded-lg text-base font-medium text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition duration-300"
                  >
                  ...
                  <p className="text-xs text-gray-500 mt-2 text-center">
                    By clicking, you'll receive a message with our product
                    information
                  </p>
                </form>
              </div>
        ...
        <div className="mt-16">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <a
              ...
              className="flex items-center px-6 py-3 bg-white hover:bg-red-50 rounded-lg transition duration-300 border border-gray-200 hover:border-red-300"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center px-6 py-3 bg-white hover:bg-pink-50 rounded-lg transition duration-300 border border-gray-200 hover:border-pink-300"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center px-6 py-3 bg-white hover:bg-blue-50 rounded-lg transition duration-300 border border-gray-200 hover:border-blue-300"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center px-6 py-3 bg-white hover:bg-yellow-50 rounded-lg transition duration-300 border border-gray-200 hover:border-yellow-300"
            >
              <img
              ...
              />
              <span className="font-medium text-sm">IndiaMART</span>
            </a>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center px-6 py-3 bg-white hover:bg-green-50 rounded-lg transition duration-300 border border-gray-200 hover:border-green-300"
            >
              ...
              <span className="font-medium text-sm">JustDial</span>
            </a>
          </div>
        </div>
      </div>
